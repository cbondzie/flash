...
GPIO.output(21, GPIO.HIGH) #put the pin21 at 0V
GPIO.output(27, GPIO.LOW)  #put the pin27 at 3.3V --> the red LED lights on
GPIO.output(17, GPIO.HIGH) #relay at rest --> flash is powered ON

print "test: flash eteint"
